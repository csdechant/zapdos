...
#include "EconomouDielectricEffectiveEFieldBC.h"

#include "MooseVariable.h"

registerMooseObject("ZapdosApp", EconomouDielectricEffectiveEFieldBC);

template <>
InputParameters
validParams<EconomouDielectricEffectiveEFieldBC>()
{
...
EconomouDielectricEffectiveEFieldBC::EconomouDielectricEffectiveEFieldBC(const InputParameters & parameters)
...
Real
EconomouDielectricEffectiveEFieldBC::computeQpResidual()
{
...
Real
EconomouDielectricEffectiveEFieldBC::computeQpJacobian()
{
...
Real
EconomouDielectricEffectiveEFieldBC::computeQpOffDiagJacobian(unsigned int jvar)
{
  ...
  else if (jvar == _Ex_id || jvar == _Ey_id || jvar == _Ez_id)
  {
    ...
    return _test[_i][_qp] * _r_units * _e[_qp] * 6.022e23 *
           (_d_ion_flux_d_Efield - _d_em_flux_d_Efield) * _normals[_qp] /
           _voltage_scaling;
  }
