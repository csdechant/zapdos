...
#include "SakiyamaIonAdvectionWithEffEfieldBCLin.h"

registerMooseObject("ZapdosApp", SakiyamaIonAdvectionWithEffEfieldBCLin);

InputParameters
SakiyamaIonAdvectionWithEffEfieldBCLin::validParams()
{
...
SakiyamaIonAdvectionWithEffEfieldBCLin::SakiyamaIonAdvectionWithEffEfieldBCLin(const InputParameters & parameters)
...
ADReal
SakiyamaIonAdvectionWithEffEfieldBCLin::computeQpResidual()
{
  ...
  //       (_a * _sgn[_qp] * _mu[_qp] * -_grad_potential[_qp] * _r_units * _u[_qp] *
  //        _normals[_qp]);

  return _test[_i][_qp] * _r_units *
         (_a * _sgn[_qp] * _mu[_qp] * EField * _r_units * _u[_qp] *
          _normals[_qp]);
}
