...
#include "ADSakiyamaSecondaryElectronBC.h"

registerMooseObject("ZapdosApp", ADSakiyamaSecondaryElectronBC);

InputParameters
ADSakiyamaSecondaryElectronBC::validParams()
{
...
ADSakiyamaSecondaryElectronBC::ADSakiyamaSecondaryElectronBC(const InputParameters & parameters)
...
ADReal
ADSakiyamaSecondaryElectronBC::computeQpResidual()
{
  _ion_flux.zero();
  for (unsigned int i = 0; i < _num_ions; ++i)
  {
