...
#include "ADSakiyamaSecondaryElectronWithEffEfieldBC.h"

registerMooseObject("ZapdosApp", ADSakiyamaSecondaryElectronWithEffEfieldBC);

InputParameters
ADSakiyamaSecondaryElectronWithEffEfieldBC::validParams()
{
...
ADSakiyamaSecondaryElectronWithEffEfieldBC::ADSakiyamaSecondaryElectronWithEffEfieldBC(const InputParameters & parameters)
...
ADReal
ADSakiyamaSecondaryElectronWithEffEfieldBC::computeQpResidual()
{
