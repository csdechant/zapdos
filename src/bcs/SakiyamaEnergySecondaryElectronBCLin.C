...
#include "SakiyamaEnergySecondaryElectronBCLin.h"

registerMooseObject("ZapdosApp", SakiyamaEnergySecondaryElectronBCLin);

InputParameters
SakiyamaEnergySecondaryElectronBCLin::validParams()
{
...
SakiyamaEnergySecondaryElectronBCLin::SakiyamaEnergySecondaryElectronBCLin(
...
ADReal
SakiyamaEnergySecondaryElectronBCLin::computeQpResidual()
{
  _ion_flux.zero();
  for (unsigned int i = 0; i < _num_ions; ++i)
  {
