...
#include "SakiyamaSecondaryElectronWithEffEfieldBCLin.h"

registerMooseObject("ZapdosApp", SakiyamaSecondaryElectronWithEffEfieldBCLin);

InputParameters
SakiyamaSecondaryElectronWithEffEfieldBCLin::validParams()
{
...
SakiyamaSecondaryElectronWithEffEfieldBCLin::SakiyamaSecondaryElectronWithEffEfieldBCLin(const InputParameters & parameters)
...
ADReal
SakiyamaSecondaryElectronWithEffEfieldBCLin::computeQpResidual()
{
