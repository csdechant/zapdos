...
#include "ADSakiyamaEnergySecondaryElectronWithEffEfieldBC.h"

registerMooseObject("ZapdosApp", ADSakiyamaEnergySecondaryElectronWithEffEfieldBC);

InputParameters
ADSakiyamaEnergySecondaryElectronWithEffEfieldBC::validParams()
{
...
ADSakiyamaEnergySecondaryElectronWithEffEfieldBC::ADSakiyamaEnergySecondaryElectronWithEffEfieldBC(
...
ADReal
ADSakiyamaEnergySecondaryElectronWithEffEfieldBC::computeQpResidual()
{
