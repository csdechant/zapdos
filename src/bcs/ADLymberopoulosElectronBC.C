...
#include "ADLymberopoulosElectronBC.h"

registerMooseObject("ZapdosApp", ADLymberopoulosElectronBC);

InputParameters
ADLymberopoulosElectronBC::validParams()
{
...
ADLymberopoulosElectronBC::ADLymberopoulosElectronBC(const InputParameters & parameters)
...
ADReal
ADLymberopoulosElectronBC::computeQpResidual()
{
  _ion_flux.zero();
  for (unsigned int i = 0; i < _num_ions; ++i)
  {
