...
#include "SakiyamaEnergySecondaryElectronWithEffEfieldBCLin.h"

registerMooseObject("ZapdosApp", SakiyamaEnergySecondaryElectronWithEffEfieldBCLin);

InputParameters
SakiyamaEnergySecondaryElectronWithEffEfieldBCLin::validParams()
{
...
SakiyamaEnergySecondaryElectronWithEffEfieldBCLin::SakiyamaEnergySecondaryElectronWithEffEfieldBCLin(
...
ADReal
SakiyamaEnergySecondaryElectronWithEffEfieldBCLin::computeQpResidual()
{
