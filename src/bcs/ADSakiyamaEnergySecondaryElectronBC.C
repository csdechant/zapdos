...
#include "ADSakiyamaEnergySecondaryElectronBC.h"

registerMooseObject("ZapdosApp", ADSakiyamaEnergySecondaryElectronBC);

InputParameters
ADSakiyamaEnergySecondaryElectronBC::validParams()
{
...
ADSakiyamaEnergySecondaryElectronBC::ADSakiyamaEnergySecondaryElectronBC(
...
ADReal
ADSakiyamaEnergySecondaryElectronBC::computeQpResidual()
{
  _ion_flux.zero();
  for (unsigned int i = 0; i < _num_ions; ++i)
  {
