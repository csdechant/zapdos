...
#include "ADElectronTemperatureDirichletBC.h"

registerMooseObject("ZapdosApp", ADElectronTemperatureDirichletBC);

InputParameters
ADElectronTemperatureDirichletBC::validParams()
{
...
ADElectronTemperatureDirichletBC::ADElectronTemperatureDirichletBC(const InputParameters & parameters)
...
ADReal
ADElectronTemperatureDirichletBC::computeQpResidual()
{
