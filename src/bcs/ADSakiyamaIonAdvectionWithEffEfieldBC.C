...
#include "ADSakiyamaIonAdvectionWithEffEfieldBC.h"

registerMooseObject("ZapdosApp", ADSakiyamaIonAdvectionWithEffEfieldBC);

InputParameters
ADSakiyamaIonAdvectionWithEffEfieldBC::validParams()
{
...
ADSakiyamaIonAdvectionWithEffEfieldBC::ADSakiyamaIonAdvectionWithEffEfieldBC(const InputParameters & parameters)
...
ADReal
ADSakiyamaIonAdvectionWithEffEfieldBC::computeQpResidual()
{
