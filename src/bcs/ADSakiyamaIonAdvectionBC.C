...
#include "ADSakiyamaIonAdvectionBC.h"

registerMooseObject("ZapdosApp", ADSakiyamaIonAdvectionBC);

InputParameters
ADSakiyamaIonAdvectionBC::validParams()
{
...
ADSakiyamaIonAdvectionBC::ADSakiyamaIonAdvectionBC(const InputParameters & parameters)
...
ADReal
ADSakiyamaIonAdvectionBC::computeQpResidual()
{
