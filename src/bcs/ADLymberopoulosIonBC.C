...
#include "ADLymberopoulosIonBC.h"

registerMooseObject("ZapdosApp", ADLymberopoulosIonBC);

InputParameters
ADLymberopoulosIonBC::validParams()
{
...
ADLymberopoulosIonBC::ADLymberopoulosIonBC(const InputParameters & parameters)
...
ADReal
ADLymberopoulosIonBC::computeQpResidual()
{
