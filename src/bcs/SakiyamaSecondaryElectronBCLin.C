...
#include "SakiyamaSecondaryElectronBCLin.h"

registerMooseObject("ZapdosApp", SakiyamaSecondaryElectronBCLin);

InputParameters
SakiyamaSecondaryElectronBCLin::validParams()
{
...
SakiyamaSecondaryElectronBCLin::SakiyamaSecondaryElectronBCLin(const InputParameters & parameters)
...
ADReal
SakiyamaSecondaryElectronBCLin::computeQpResidual()
{
  _ion_flux.zero();
  for (unsigned int i = 0; i < _num_ions; ++i)
  {
