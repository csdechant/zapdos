...
#include "AddDriftDiffusionActionEM.h"
#include "Parser.h"
#include "FEProblem.h"
#include "Factory.h"
#include "MooseEnum.h"
...
registerMooseAction("ZapdosApp", AddDriftDiffusionActionEM, "add_variable");
registerMooseAction("ZapdosApp", AddDriftDiffusionActionEM, "add_kernel");
registerMooseAction("ZapdosApp", AddDriftDiffusionActionEM, "add_aux_kernel");
registerMooseAction("ZapdosApp", AddDriftDiffusionActionEM, "add_bc");

template <>
InputParameters
validParams<AddDriftDiffusionActionEM>()
{
...
AddDriftDiffusionActionEM::AddDriftDiffusionActionEM(InputParameters params) : AddVariableAction(params) {}

void
AddDriftDiffusionActionEM::act()
{
