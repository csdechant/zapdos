...
#include "ADReactionSecondOrderLogForShootMethod.h"

registerMooseObject("ZapdosApp", ADReactionSecondOrderLogForShootMethod);

InputParameters
ADReactionSecondOrderLogForShootMethod::validParams()
{
...
ADReactionSecondOrderLogForShootMethod::ADReactionSecondOrderLogForShootMethod(
...
ADReal
ADReactionSecondOrderLogForShootMethod::computeQpResidual()
{
  Real power;
