...
#include "ADReactionSecondOrderForShootMethod.h"

registerMooseObject("ZapdosApp", ADReactionSecondOrderForShootMethod);

InputParameters
ADReactionSecondOrderForShootMethod::validParams()
{
...
ADReactionSecondOrderForShootMethod::ADReactionSecondOrderForShootMethod(
...
ADReal
ADReactionSecondOrderForShootMethod::computeQpResidual()
{
  Real power;
