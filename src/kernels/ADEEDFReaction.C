#include "ADEEDFReaction.h"

// MOOSE includes
#include "MooseUtils.h"
#include "MooseVariable.h"

registerADMooseObject("CraneApp", ADEEDFReaction);

InputParameters
ADEEDFReaction::validParams()
{
...
ADEEDFReaction::ADEEDFReaction(const InputParameters & parameters)
  : ADKernel(parameters),
...
ADReal
ADEEDFReaction::computeQpResidual()
{
  return -_test[_i][_qp] * _reaction_coeff[_qp] * _em[_qp] * _target[_qp] * _coefficient;
}
