...
#include "ADEffectiveEFieldAdvection.h"

registerADMooseObject("ZapdosApp", ADEffectiveEFieldAdvection);

InputParameters
ADEffectiveEFieldAdvection::validParams()
{
...
ADEffectiveEFieldAdvection::ADEffectiveEFieldAdvection(const InputParameters & parameters)
  : ADKernel(parameters),
...
ADReal
ADEffectiveEFieldAdvection::computeQpResidual()
{
