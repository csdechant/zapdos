#include "ADEEDFEnergy.h"

// MOOSE includes
#include "MooseUtils.h"
#include "MooseVariable.h"

registerADMooseObject("CraneApp", ADEEDFEnergy);

InputParameters
ADEEDFEnergy::validParams()
{
...
ADEEDFEnergy::ADEEDFEnergy(const InputParameters & parameters)
  : ADKernel(parameters),
...
ADReal
ADEEDFEnergy::computeQpResidual()
{
  return -_test[_i][_qp] * _reaction_coefficient[_qp] * _em[_qp] * _target[_qp] *
         _threshold_energy;
}
