...
registerMooseObject("ZapdosApp", ProductABRxn);

template <>
InputParameters
validParams<ProductABRxn>()
{
...
ProductABRxn::ProductABRxn(const InputParameters & parameters)
  : Kernel(parameters),
...
Real
ProductABRxn::computeQpResidual()
{
...
Real
ProductABRxn::computeQpJacobian()
{
  return 0.0;
}

Real
ProductABRxn::computeQpOffDiagJacobian(unsigned int jvar)
{
