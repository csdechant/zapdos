...
#include "ADThermalConductivityDiffusion.h"

registerADMooseObject("ZapdosApp", ADThermalConductivityDiffusion);

InputParameters
ADThermalConductivityDiffusion::validParams()
{
...
ADThermalConductivityDiffusion::ADThermalConductivityDiffusion(const InputParameters & parameters)
  : ADKernel(parameters),
...
ADReal
ADThermalConductivityDiffusion::computeQpResidual()
{
