...
#include "ADEEDFReactionLogForShootMethod.h"

registerMooseObject("ZapdosApp", ADEEDFReactionLogForShootMethod);

InputParameters
ADEEDFReactionLogForShootMethod::validParams()
{
...
ADEEDFReactionLogForShootMethod::ADEEDFReactionLogForShootMethod(const InputParameters & parameters)
  : ADKernel(parameters),
...
ADReal
ADEEDFReactionLogForShootMethod::computeQpResidual()
{
