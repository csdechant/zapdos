...
#include "ADReactionThirdOrderLogForShootMethod.h"

registerMooseObject("ZapdosApp", ADReactionThirdOrderLogForShootMethod);

InputParameters
ADReactionThirdOrderLogForShootMethod::validParams()
{
...
ADReactionThirdOrderLogForShootMethod::ADReactionThirdOrderLogForShootMethod(
...
ADReal
ADReactionThirdOrderLogForShootMethod::computeQpResidual()
{
  Real power;
