...
#include "EffectiveEFieldAdvectionLin.h"

registerADMooseObject("ZapdosApp", EffectiveEFieldAdvectionLin);

InputParameters
EffectiveEFieldAdvectionLin::validParams()
{
...
EffectiveEFieldAdvectionLin::EffectiveEFieldAdvectionLin(const InputParameters & parameters)
  : ADKernel(parameters),
...
ADReal
EffectiveEFieldAdvectionLin::computeQpResidual()
{
