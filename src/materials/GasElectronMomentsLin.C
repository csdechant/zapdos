...
#include "GasElectronMomentsLin.h"
#include "MooseUtils.h"

registerMooseObject("ZapdosApp", GasElectronMomentsLin);

InputParameters
GasElectronMomentsLin::validParams()
{
...
GasElectronMomentsLin::GasElectronMomentsLin(const InputParameters & parameters)
  : Material(parameters),
...
void
GasElectronMomentsLin::computeQpProperties()
{
