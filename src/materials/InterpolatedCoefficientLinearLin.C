#include "InterpolatedCoefficientLinearLin.h"
#include "MooseUtils.h"

// MOOSE includes
#include "MooseVariable.h"

registerADMooseObject("CraneApp", InterpolatedCoefficientLinearLin);

InputParameters
InterpolatedCoefficientLinearLin::validParams()
{
...
InterpolatedCoefficientLinearLin::InterpolatedCoefficientLinearLin(const InputParameters & parameters)
...
void
InterpolatedCoefficientLinearLin::computeQpProperties()
{
  _coefficient[_qp].value() =
      _coefficient_interpolation->sample(_mean_en[_qp].value() / _em[_qp].value());
