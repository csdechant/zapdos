...
#include "FVOrthogonalBoundaryDiffusionLog.h"
#include "Function.h"

registerMooseObject("MooseApp", FVOrthogonalBoundaryDiffusionLog);

InputParameters
FVOrthogonalBoundaryDiffusionLog::validParams()
{
...
FVOrthogonalBoundaryDiffusionLog::FVOrthogonalBoundaryDiffusionLog(
...
ADReal
FVOrthogonalBoundaryDiffusionLog::computeQpResidual()
{
  ...
  return -coeff * (_function.value(_t, _face_info->faceCentroid()) - std::exp(diff_quant)) /
