...
#include "FVDriftDiffusionDoNothingBCNonLog.h"
#include "Function.h"

registerMooseObject("ZapdosApp", FVDriftDiffusionDoNothingBCNonLog);

InputParameters
FVDriftDiffusionDoNothingBCNonLog::validParams()
{
...
FVDriftDiffusionDoNothingBCNonLog::FVDriftDiffusionDoNothingBCNonLog(
...
ADReal
FVDriftDiffusionDoNothingBCNonLog::computeQpResidual()
{
  using namespace Moose::FV;
  ...
  return _r_units * (_sign[_qp] * mobility * -grad_potential * _r_units * u_interface * _normal -
                     diffusivity * dudn * _r_units);
}
