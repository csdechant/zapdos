...
#include "FVLymberopoulosIonBCNonLog.h"
#include "Function.h"

registerMooseObject("ZapdosApp", FVLymberopoulosIonBCNonLog);

InputParameters
FVLymberopoulosIonBCNonLog::validParams()
{
...
FVLymberopoulosIonBCNonLog::FVLymberopoulosIonBCNonLog(const InputParameters & parameters)
  : FVFluxBC(parameters),
...
ADReal
FVLymberopoulosIonBCNonLog::computeQpResidual()
{
  using namespace Moose::FV;
  ...
  return _r_units * mobility * -grad_potential * _r_units * u_interface * _normal;
}
