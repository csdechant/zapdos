...
FVSakiyamaEnergySecondaryElectronBCNonLog::FVSakiyamaEnergySecondaryElectronBCNonLog(const InputParameters & parameters)
  : FVFluxBC(parameters),
...
FVSakiyamaEnergySecondaryElectronBCNonLog::computeQpResidual()
{
  ...
  return -1.0 * _r_units * _se_coeff * (5.0 / 3.0) * _se_energy * _ion_flux *
         _normal;
}
