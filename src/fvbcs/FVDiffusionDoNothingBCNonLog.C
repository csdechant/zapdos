...
#include "FVDiffusionDoNothingBCNonLog.h"
#include "Function.h"

registerMooseObject("ZapdosApp", FVDiffusionDoNothingBCNonLog);

InputParameters
FVDiffusionDoNothingBCNonLog::validParams()
{
...
FVDiffusionDoNothingBCNonLog::FVDiffusionDoNothingBCNonLog(const InputParameters & parameters)
  : FVFluxBC(parameters),
...
ADReal
FVDiffusionDoNothingBCNonLog::computeQpResidual()
{
  using namespace Moose::FV;
  ...
  return _r_units * -1.0 * diffusivity * dudn * _r_units;
}
