...
[ICs]
  ...
  [./O-_ic]
    type = FunctionIC
    variable = O-
    function = neg_ion_density_ic_func
  [../]
  [./O2+_ic]
    type = FunctionIC
    variable = O2+
    function = pos_ion_density_ic_func
  [../]
  [./mean_en_ic]
    type = FunctionIC
    variable = mean_en
...
[Functions]
  [./potential_top_bc_func]
    type = ParsedFunction
    value = '37.5*sin(2*pi*13.56e6*t)'
  [../]
  [./potential_bottom_bc_func]
    type = ParsedFunction
    value = '-37.5*sin(2*pi*13.56e6*t)'
  [../]
  [./pos_ion_density_ic_func]
    type = ParsedFunction
    value = 'log(1.0 * (1e13 + 1e15 * (1-x/(45e-3))^2 * (x/(45e-3))^2)/6.022e23)'
  [../]
  [./neg_ion_density_ic_func]
    type = ParsedFunction
    value = 'log(0.875 * (1e13 + 1e15 * (1-x/(45e-3))^2 * (x/(45e-3))^2)/6.022e23)'
  [../]
  [./density_ic_func]
    type = ParsedFunction
    value = 'log(0.125 * (1e13 + 1e15 * (1-x/(45e-3))^2 * (x/(45e-3))^2)/6.022e23)'
  [../]
  [./energy_density_ic_func]
    type = ParsedFunction
    value = 'log(3./2.) + log(0.125 * (1e13 + 1e15  * (1-x/(45e-3))^2 * (x/(45e-3))^2)/6.022e23)'
  [../]
[]
