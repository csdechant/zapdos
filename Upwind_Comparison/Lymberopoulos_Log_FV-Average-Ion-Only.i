# Notes:
# Failed at 'time = 2.2035e-06' with 'Solve failed and timestep already at or below dtmin'
...
#Boundary conditions for electons
  [./em_physical_right]
    ...
    potential = potential
    position_units = ${dom0Scale}
    # Using Averaging since the advection term is based on the ions
    advected_interp_method = average
  [../]
  [./em_physical_left]
    type = FVLymberopoulosElectronBC
...
[Outputs]
  file_base = 'Log-Average_ions-Upwind_em_mean'
  perf_graph = true
  [./out]
    type = Exodus
  [../]
