# Notes:
# (1)'advected_interp_method = average' with 'uniform_refine = 0'
#     run to completion 'end_time = 1e-6'
# (2)'advected_interp_method = upwind' with 'uniform_refine = 0'
#     run to completion 'end_time = 1e-6'
# (3)'advected_interp_method = upwind' with 'uniform_refine = 1'
#     failed at 'time = 9.86672e-07' with 'PC failed due to FACTOR_OUTMEMORY'
...
[Outputs]
  #file_base = 'Log-Average-Refine-00'
  #file_base = 'Log-Upwind-Refine-00'
  file_base = 'Log-Upwind-Refine-01'
  perf_graph = true
  [./out]
    type = Exodus
  [../]
