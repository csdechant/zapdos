...
[Functions]
  [./potential_bc_func]
    type = ParsedFunction
    value = '330*cos(2*3.1415926*13.56e6*t)'
    # value = '0.2'
  [../]
  #[./potential_bc_func2]
  #  type = ParsedFunction
  #  value = '-500*cos(2*3.1415926*13.56e6*t)'
  #  # value = '0.2'
  #[../]
  [./potential_ic_func]
    type = ParsedFunction
...
[Materials]
  [./GasBasics]
    ...
    property_tables_file = Helium_TEST/electron_moments.txt
    position_units = ${dom0Scale}
  [../]
  [./gas_species_0]
...
[ChemicalReactions]
  [./ZapdosNetwork]
    ...
    reactions = 'He + em -> He* + em                    : BOLOS [-19.8]
                 ...
                 em + em + He+ -> em + He*              : 1.63e-21*(Te*1160.4505)^-4.5'
...
[Outputs]
  file_base = Helium_rf_NO_SCALE_TEST_330VV
  print_perf_log = true
