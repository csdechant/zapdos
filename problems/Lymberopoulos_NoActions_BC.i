...
#Setting the excited atoms close to zero
#The paper has the BC set to zero, but since Zapdos uses the exponent
...
#  boundary = 'left'
#  [../]
#BC for Argon neutrals
#NEED TO CHANGE FROM DEFAULT BC TO NEW BC
  [./Ar*_physical_right_diffusion]
...
[Materials]
  [./GasBasics]
    ...
    property_tables_file = Argon_reactions_Morgan/electron_moments.txt
    position_units = ${dom0Scale}
  [../]
  [./gas_species_0]
