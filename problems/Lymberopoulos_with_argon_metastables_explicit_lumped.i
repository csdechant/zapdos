#This input file as no Preconditioning.

#When all kernels have "implicit=true", simulation diverged at 2nd time step.

#When all kernels have "implicit=false", simulation solves, but solution is just...
#equal to the initial conditions.

#When only the time Kernels have "implicit=false", simulation solves, but solution is just...
#equal to the initial conditions.
