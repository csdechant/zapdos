...
[ChemicalReactions]
  [./ZapdosNetwork]
    ...
    reactions = 'em + Ar -> em + Ar                  : BOLOS [elastic]
                 em + Ar -> em + Ar*                 : BOLOS [-11.5]
                 em + Ar -> em + em + Ar+            : BOLOS [-1.576e1]
                 em + Ar* -> em + em + Ar+           : BOLOS [-4.30]
    ...
    # reactions = 'He + em -> Ar* + em          : {3.88e-16*exp(-1.4e6/Efield)}
    #              He + em -> Ar+ + em + em     : {4.75e-16*exp(-2.31e6/Efield)}
    #              Ar* + em -> Ar+ + em + em    : {2.02e-13*exp(-3.10e5/Efield)}
    #              Ar* + He + He -> Ar_2* + He  : 2.0e-46
    #              Ar+ + He + He -> Ar_2+ + He  : 1.1e-43
    #              Ar_2* -> He + He             : 1.0e4
    #              Ar* + Ar* -> Ar_2+ + em      : 1.5e-15
    #              Ar_2* + Ar_2* -> Ar_2+ + em  : 1.5e-15
    #              Ar_2+ + em -> Ar* + He       : {8.9e-15*((Te*11600/Tg)^(-1.5))}
    #              Ar* + N_2 -> N_2+ + He + em  : 5.0e-17
    #              Ar_2* + N_2 -> N_2+ + em     : 3.0e-17
    #              Ar_2+ + N_2 -> N_2+ + Ar_2*  : 1.4e-15
...
[Outputs]
  print_perf_log = true
  file_base = Argon_COST_rf_SCALE_Test
