#This input file usings Lump Preconditioning.

#When all kernels have "implicit=true", simulation diverged at 2nd time step...
#caused by "DIVERGED_NANORINF".

#When all kernels have "implicit=false", simulation diverged at 8th time step...
#caused by "DIVERGED_BREAKDOWN".

#When only the time Kernels have "implicit=false", simulation diverged at 8th time step...
#caused by "DIVERGED_BREAKDOWN".
