#!/usr/bin/env python3
# Script to run spatial convergence study on scalarLog_divergenceMatVelocity_product.i
...
for i in range(0, runs):
    ...
    # Read the file
    root = pyhit.load('scalarLog_divergenceMatVelocity_product.i')
    ...
    pyhit.write("scalarLog_divergenceMatVelocity_product.i", root)

    input_files = ['scalarLog_divergenceMatVelocity_product.i']
...
fig.save('scalarLog_divergenceMatVelocity_product.png')
data.to_csv('scalarLog_divergenceMatVelocity_product.csv')
