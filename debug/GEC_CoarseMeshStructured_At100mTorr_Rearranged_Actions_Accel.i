...
[Reactions]
  [./Argon]
    ...
    file_location = 'Argon_reactions_paper_RateCoefficients100mTorr'
    potential = 'potential'
    use_log = true
    position_units = ${dom0Scale}
    block = 'plasma'
...
[Materials]
  [./GasBasics]
    ...
    mean_en = mean_en
    user_se_coeff = 0.00
    property_tables_file = Argon_reactions_paper_RateCoefficients100mTorr/electron_moments.txt
  [../]
  [./gas_species_0]
...
[MultiApps]
  ...
  [./Shooting]
    ...
    input_files = 'GEC_CoarseMeshStructured_At100mTorr_Rearranged_Actions_Shooting.i'
    execute_on = 'TIMESTEP_END'
    enable = false
  [../]
[]
