...
#Simulation failed at t=3.17656e-8 due to
#"Nonlinear solve did not converge due to DIVERGED_FNORM_NAN iterations 0"
#During run, 0th nonlinear residual somewhat high,
#|R|~1e6 and converges were due to the relative tolerance.
#(This is better that the current dielectric BC by a magnetude.)
#Outlier residual throught most of the run was potential.

#Results are similar to the Action run, so the problems is probably not with
#the action systems
