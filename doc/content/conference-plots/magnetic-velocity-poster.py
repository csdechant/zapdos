...
ax1.loglog(h_p,u_p, marker='o', linestyle='solid',color='g',label='$\\vec v _\\parallel$: {:.3f}'.format(u_p_slope[0]))
ax1.loglog(h_e,u_e, marker='o', linestyle='solid',color='r',label='$\\vec v _E$: {:.3f}'.format(u_e_slope[0]))
ax1.loglog(h_d,u_d, marker='o', linestyle='solid',color='b',label='$\\vec v ^*$: {:.3f}'.format(u_d_slope[0]))
