...
`LogStabilizationMoles` adds an offset to the applied variable in log form. In Zapdos,
densities and energy densities are treated in log form to avoid negative values. This is
represented as
...
Where $N_{j}$ and $N_{\varepsilon}$ are the log forms of the density and energy
