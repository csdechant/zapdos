...
if "/zapdos/doc/" in script_folder.lower():     # if in documentation folder
    csv_folder = "../../../test/tests/mms/magnetized_plasma/continuity_equations/perpendicular_diffusion/gold/perpendicular_diffusion.csv"
...
ax1.loglog(h,u, marker='o', linestyle='solid',color='b',label='$f$ solved with $\\nabla _\\perp$: {:.3f}'.format(u_slope[0]))
ax1.grid(True, which='both', color=[0.8]*3)
plt.legend(loc='upper left')
fig.set_figwidth(5.5)
fig.set_figheight(6)
fig.savefig('perpendicular_diffusion_convergence.png', bbox_inches='tight', dpi=300)
