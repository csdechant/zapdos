...
[Kernels]
  ...
  #Argon Ion Equations (Same as in paper)
    ...
    [./Ar+_pooling]
      ...
      coefficient = 1
    [../]
    #Log Offset for ion density, not in paper since Zapdos uses an exponent form of density
...
[Functions]
  [./potential_bc_func]
    type = ParsedFunction
    value = '0.150*sin(2*3.1415926*13.56e6*t)'
  [../]
  [./potential_ic_func]
    type = ParsedFunction
    value = '0.150*sin(0)'
...
[Materials]
  [./GasBasics]
    ...
    property_tables_file = Argon_reactions_test/electron_moments.txt
    position_units = ${dom0Scale}
  [../]
  [./gas_species_0]
  ...
  [./reaction_0]
    ...
    property_file = 'Argon_reactions_test/reaction_em + Ar -> em + Ar*.txt'
    reaction = 'em + Ar -> em + Ar*'
    position_units = ${dom0Scale}
    file_location = ''
    em = em
  ...
  [./reaction_1]
    ...
    mean_en = mean_en
    sampling_format = electron_energy
    property_file = 'Argon_reactions_test/reaction_em + Ar -> em + em + Ar+.txt'
    reaction = 'em + Ar -> em + em + Ar+'
    position_units = ${dom0Scale}
    file_location = ''
    em = em
...
[Outputs]
  print_perf_log = true
  #file_base = Lymberopoulos_NoActions_BC_test_25
