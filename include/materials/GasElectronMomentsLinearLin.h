...
class GasElectronMomentsLinearLin : public ADMaterial
{
public:
  GasElectronMomentsLinearLin(const InputParameters & parameters);
...
protected:
  ...
  std::unique_ptr<LinearInterpolation> _alpha_interpolation;
  std::unique_ptr<LinearInterpolation> _alphaEx_interpolation;
  std::unique_ptr<LinearInterpolation> _alphaEl_interpolation;
  std::unique_ptr<LinearInterpolation> _mu_interpolation;
  std::unique_ptr<LinearInterpolation> _diff_interpolation;
