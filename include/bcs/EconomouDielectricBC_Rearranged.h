...
#ifndef EconomouDielectricBC_Rearranged_H
#define EconomouDielectricBC_Rearranged_H

#include "IntegratedBC.h"

class EconomouDielectricBC_Rearranged;

template <>
InputParameters validParams<EconomouDielectricBC_Rearranged>();

class EconomouDielectricBC_Rearranged : public IntegratedBC
{
public:
  /**
   ...
   * constructor.
   */
  EconomouDielectricBC_Rearranged(const InputParameters & parameters);
