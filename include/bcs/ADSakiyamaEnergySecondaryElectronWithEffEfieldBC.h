...
class ADSakiyamaEnergySecondaryElectronWithEffEfieldBC : public ADIntegratedBC
{
public:
  static InputParameters validParams();

  ADSakiyamaEnergySecondaryElectronWithEffEfieldBC(const InputParameters & parameters);
