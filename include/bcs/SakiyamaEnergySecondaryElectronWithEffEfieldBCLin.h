...
class SakiyamaEnergySecondaryElectronWithEffEfieldBCLin : public ADIntegratedBC
{
public:
  static InputParameters validParams();

  SakiyamaEnergySecondaryElectronWithEffEfieldBCLin(const InputParameters & parameters);
