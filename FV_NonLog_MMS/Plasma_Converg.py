...
df1 = mms.run_spatial('FV_2D_Coupling_Electons_Potential_Ions_SGTest.i', 4, y_pp=['em_l2Error','ion_l2Error','potential_l2Error'],mpi=6)

fig = mms.ConvergencePlot(xlabel='Element Size ($h$)', ylabel='$L_2$ Error')
fig.plot(df1, label=['em_l2Error','ion_l2Error','potential_l2Error'], marker='o', markersize=8, num_fitted_points=5)
fig.save('FV_2D_Coupling_Electons_Potential_Ions_SGTest.png')
df1.to_csv('FV_2D_Coupling_Electons_Potential_Ions_SGTest.csv')
