...
x_pp = 'h'
y_pp = ['vector_velocity_l2Error', 'div_velocity_l2Error']
...
for i in range(0, runs):
    ...
    # Read the file
    root = pyhit.load('divergence_operation_Lagrange.i')
    ...
    pyhit.write("divergence_operation_Lagrange.i", root)

    input_files = ['divergence_operation_Lagrange.i']
...
fig.plot(data, label=['vector velocity', 'divergence'], marker='o', markersize=8)
fig.save('divergence_operation_Lagrange.png')
data.to_csv('divergence_operation_Lagrange.csv')