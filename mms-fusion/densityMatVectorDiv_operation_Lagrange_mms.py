...
for i in range(0, runs):
    ...
    # Read the file
    root = pyhit.load('densityMatVectorDiv_operation_Lagrange.i')
    ...
    pyhit.write("densityMatVectorDiv_operation_Lagrange.i", root)

    input_files = ['densityMatVectorDiv_operation_Lagrange.i']
...
fig.save('densityMatVectorDiv_operation_Lagrange.png')
data.to_csv('densityMatVectorDiv_operation_Lagrange.csv')
