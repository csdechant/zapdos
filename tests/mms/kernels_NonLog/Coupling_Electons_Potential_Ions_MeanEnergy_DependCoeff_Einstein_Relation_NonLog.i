...
#Manufactured Solutions
  ...
  [./energy_fun]
    ...
    vars = 'l f'
    vals = 'l f'
    value = '(x*(1.-x/l) + sin(2.*pi*f*t)*cos(pi*x/l)*x*(1.-x/l) + 0.75)'
  [../]
  [./mean_en_fun]
    type = ParsedFunction
...
#Source Terms in moles
  ...
  [./energy_source]
    ...
    value = '((diffem_coeff*((x/l - 1)/l + x/l^2 + (pi*sin((pi*x)/l)*sin(2*pi*f*t))/(5*l))*((x*(x/l - 1))/l +
              ...
              (ee*l*muem_coeff*sin((pi*x)/l)*sin(2*pi*f*t)*((x/l - 1)/l + x/l^2 +
              (pi*sin((pi*x)/l)*sin(2*pi*f*t))/(5*l))*((x*(x/l - 1))/l +
              x*cos((pi*x)/l)*sin(2*pi*f*t)*(x/l - 1) - 3/4))/(5*diffpotential*pi)) -
              diffem_coeff*((cos((pi*x)/l)*sin(2*pi*f*t))/5 - (x*(x/l - 1))/l + 1)*((x/l - 1)/l + x/l^2 +
              cos((pi*x)/l)*sin(2*pi*f*t)*(x/l - 1) + (x*cos((pi*x)/l)*sin(2*pi*f*t))/l -
              (x*pi*sin((pi*x)/l)*sin(2*pi*f*t)*(x/l - 1))/l)^2 + diffem_coeff*((x/l - 1)/l + x/l^2 +
              (pi*sin((pi*x)/l)*sin(2*pi*f*t))/(5*l))*((x*(x/l - 1))/l +
              x*cos((pi*x)/l)*sin(2*pi*f*t)*(x/l - 1) - 3/4)*((x/l - 1)/l + x/l^2 + cos((pi*x)/l)*sin(2*pi*f*t)*(x/l - 1) +
              (x*cos((pi*x)/l)*sin(2*pi*f*t))/l - (x*pi*sin((pi*x)/l)*sin(2*pi*f*t)*(x/l - 1))/l) +
              diffem_coeff*((x*(x/l - 1))/l + x*cos((pi*x)/l)*sin(2*pi*f*t)*(x/l - 1) - 3/4)*((cos((pi*x)/l)*sin(2*pi*f*t))/5 -
              (x*(x/l - 1))/l + 1)*((2*x*pi*sin((pi*x)/l)*sin(2*pi*f*t))/l^2 - (2*cos((pi*x)/l)*sin(2*pi*f*t))/l - 2/l^2 +
              ...
              (ee*l*sin((pi*x)/l)*sin(2*pi*f*t)*(diffem_coeff*((x/l - 1)/l + x/l^2 +
              (pi*sin((pi*x)/l)*sin(2*pi*f*t))/(5*l))*((x*(x/l - 1))/l + x*cos((pi*x)/l)*sin(2*pi*f*t)*(x/l - 1) - 3/4) +
              (ee*l*muem_coeff*sin((pi*x)/l)*sin(2*pi*f*t)*((x*(x/l - 1))/l +
              x*cos((pi*x)/l)*sin(2*pi*f*t)*(x/l - 1) - 3/4)*((cos((pi*x)/l)*sin(2*pi*f*t))/5 -
...
[Materials]
  ...
  [./Material_Coeff_Deriv]
    ...
    prop_values = 'mumean_en_coeff               diffmean_en_coeff               muem_coeff               diffem_coeff'
  [../]
  [./Charge_Signs]
