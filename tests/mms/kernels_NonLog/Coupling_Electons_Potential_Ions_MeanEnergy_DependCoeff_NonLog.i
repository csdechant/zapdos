...
#Source Terms in moles
  ...
  [./energy_source]
    ...
    value = '((diffem_coeff*((x/l - 1)/l + x/l^2 + (pi*sin((pi*x)/l)*sin(2*pi*f*t))/(5*l))*((x*(x/l - 1))/l +
              ...
              (5*x*pi*sin((pi*x)/l)*sin(2*pi*f*t)*(x/l - 1))/(3*l)) +
              ((5*x*(x/l - 1))/(3*l) + (5*x*cos((pi*x)/l)*sin(2*pi*f*t)*(x/l - 1))/3 - 5/4)*(diffem_coeff*((x/l - 1)/l + x/l^2 +
              ...
              (x*cos((pi*x)/l)*sin(2*pi*f*t))/l - (x*pi*sin((pi*x)/l)*sin(2*pi*f*t)*(x/l - 1))/l)^2 + diffem_coeff*((5*(x/l - 1))/(3*l) +
              (5*x)/(3*l^2) + (pi*sin((pi*x)/l)*sin(2*pi*f*t))/(3*l))*((x*(x/l - 1))/l +
