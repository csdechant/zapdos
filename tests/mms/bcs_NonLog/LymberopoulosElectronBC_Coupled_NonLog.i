#This MMS test was designed to test the non-log version of LymberopoulosElectronBC,
...
#Manufactured Solutions
  ...
  [./em_fun]
    ...
    vars = 'l f N_A'
    vals = 'l f N_A'
    value = '((sin(2.*pi*f*t) + 2.) * ((x/l)*(1. - x/l) + 1.)) / N_A'
  [../]
...
#Source Terms in moles
  ...
  [./em_left_Flux_BC]
    ...
    vars = 'l f diffem muem N_A'
    vals = 'l f diffem muem N_A'
    value = '(-(diffem*(sin(2.*pi*f*t) + 2.))/l) / N_A'
  [../]
  ...
  [./em_right_Flux_BC]
    ...
    vars = 'l f diffem muem N_A'
    vals = 'l f diffem muem N_A'
    value = '-1.0 * ((diffem*(sin(2.*pi*f*t) + 2.))/l - muem*(sin(2.*pi*f*t) + 2.)*((2.*sin(2.*pi*f*t))/l - 2./l)) / N_A'
  [../]
...
[Materials]
  [./Material_Coeff]
    ...
    prop_names =  'e  diffpotential diffem muem diffion muion N_A'
    prop_values = 'ee diffpotential diffem muem diffion muion N_A'
  [../]
