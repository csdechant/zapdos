...
#the mean electron energy density and CRANE's kernel "EEDFElasticLog"
...
[Outputs]
  file_base = 'Coupling_EEDFElasticLog_out'
  #file_base = 'Coupling_EEDFElasticLog_UsingTempDiff_out'
  perf_graph = true
  [./out]
    type = Exodus
  [../]
