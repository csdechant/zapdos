...
#Source Terms in moles
  ...
  [./Ex_left_BC]
    ...
    vars = 'ee N_A diffpotential diffion muion'
    vals = 'ee N_A diffpotential diffion muion'
    value = '(diffion*pi)/(muion*(sin(pi*y) + (cos(pi*y)*sin(2*pi*t))/5 + 1))'
  [../]
  [./Ey_left_BC]
    type = ParsedFunction
    vars = 'ee N_A diffpotential diffion muion'
    vals = 'ee N_A diffpotential diffion muion'
    value = '(diffion*(pi*cos(pi*y) - (pi*sin(2*pi*t)*sin(pi*y))/5))/(muion*(sin(pi*y) + (cos(pi*y)*sin(2*pi*t))/5 + 1))'
  [../]
  ...
  [./Ex_down_BC]
    ...
    vars = 'ee N_A diffpotential diffion muion'
    vals = 'ee N_A diffpotential diffion muion'
    value = '(diffion*pi*cos(pi*x))/(muion*(sin(2*pi*t)/5 + sin(pi*x) + 1))'
  [../]
  [./Ey_down_BC]
    type = ParsedFunction
    vars = 'ee N_A diffpotential diffion muion'
    vals = 'ee N_A diffpotential diffion muion'
    value = '(diffion*pi)/(muion*(sin(2*pi*t)/5 + sin(pi*x) + 1))'
  [../]
  ...
  [./Ex_up_BC]
    ...
    vars = 'ee N_A diffpotential diffion muion'
    vals = 'ee N_A diffpotential diffion muion'
    value = '(diffion*pi*cos(pi*x))/(muion*(sin(pi*x) - sin(2*pi*t)/5 + 1))'
  [../]
  [./Ey_up_BC]
    type = ParsedFunction
    vars = 'ee N_A diffpotential diffion muion'
    vals = 'ee N_A diffpotential diffion muion'
    value = '-(diffion*pi)/(muion*(sin(pi*x) - sin(2*pi*t)/5 + 1))'
  [../]
