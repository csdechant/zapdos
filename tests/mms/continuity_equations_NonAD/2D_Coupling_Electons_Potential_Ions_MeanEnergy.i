...
[Materials]
  [./Material_Coeff_Set00]
    type = GenericFunctionMaterial
    prop_names =  'e N_A'
    prop_values = 'ee N_A'
  [../]
  [./Material_Coeff_Set01]
    type = GenericFunctionMaterial
    prop_names =  'diffpotential diffion muion diffem muem diffmean_en mumean_en'
    prop_values = 'diffpotential diffion muion diffem muem diffmean_en mumean_en'
  [../]
