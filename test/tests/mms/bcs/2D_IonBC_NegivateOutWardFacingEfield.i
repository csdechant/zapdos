...
#Source Terms in moles
  ...
  #  value = '((2*pi*cos(2*pi*t)*cos(pi*y))/5) / N_A'
    type = ParsedFunction
    value = '-diffion*(-pi^2*sin(y*pi) - 0.2*pi^2*sin(2*pi*t)*cos(y*pi))/N_A + diffion*(-pi^2*sin(y*pi) - 1/5*pi^2*sin(2*pi*t)*cos(y*pi))*(sin(x*pi) + sin(y*pi) + 0.2*sin(2*pi*t)*cos(y*pi) + 1.0)/(N_A*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)) + diffion*(-0.2*pi*sin(y*pi)*sin(2*pi*t) + pi*cos(y*pi))*(-1/5*pi*sin(y*pi)*sin(2*pi*t) + pi*cos(y*pi))/(N_A*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)) + diffion*(-1/5*pi*sin(y*pi)*sin(2*pi*t) + pi*cos(y*pi))*((1/5)*pi*sin(y*pi)*sin(2*pi*t) - pi*cos(y*pi))*(sin(x*pi) + sin(y*pi) + 0.2*sin(2*pi*t)*cos(y*pi) + 1.0)/(N_A*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^2) + pi^2*diffion*sin(x*pi)/N_A - pi^2*diffion*(sin(x*pi) + sin(y*pi) + 0.2*sin(2*pi*t)*cos(y*pi) + 1.0)*sin(x*pi)/(N_A*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)) + pi^2*diffion*cos(x*pi)^2/(N_A*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)) - pi^2*diffion*(sin(x*pi) + sin(y*pi) + 0.2*sin(2*pi*t)*cos(y*pi) + 1.0)*cos(x*pi)^2/(N_A*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^2) + 0.4*pi*cos(y*pi)*cos(2*pi*t)/N_A'
    vars = 'N_A diffion'
    vals = 'N_A diffion'
  [../]
  ...
  #  value = '-diffpotential*((2*diffion*pi^3*cos(pi*x)^3)/(muion*(sin(x*pi) + sin(y*pi) + (cos(y*pi)*sin(2*t*pi))/5 + 1)^3) - (diffion*pi^3*cos(pi*x))/(muion*(sin(pi*x) + sin(pi*y) + (cos(pi*y)*sin(2*pi*t))/5 + 1)) + (3*diffion*pi^3*cos(pi*x)*sin(pi*x))/(muion*(sin(x*pi) + sin(y*pi) + (cos(y*pi)*sin(2*t*pi))/5 + 1)^2)) - (2*diffion*diffpotential*pi*cos(pi*x)*(pi*cos(pi*y) - (pi*sin(2*pi*t)*sin(pi*y))/5)^2)/(muion*(sin(x*pi) + sin(y*pi) + (cos(y*pi)*sin(2*t*pi))/5 + 1)^3) - #(2*diffion*pi^2*cos(2*pi*t)*cos(pi*x)*cos(pi*y))/(5*muion*(sin(x*pi) + sin(y*pi) + (cos(y*pi)*sin(2*t*pi))/5 + 1)^2) - (diffion*diffpotential*pi*cos(pi*x)*(pi^2*sin(pi*y) + (pi^2*cos(pi*y)*sin(2*pi*t))/5))/(muion*(sin(x*pi) + sin(y*pi) + (cos(y*pi)*sin(2*t*pi))/5 + 1)^2)'
    type = ParsedFunction
    value = '-pi*diffion*diffpotential*(pi^2*sin(y*pi) + (1/5)*pi^2*sin(2*pi*t)*cos(y*pi))*cos(x*pi)/(muion*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^2) - pi*diffion*diffpotential*((1/5)*pi*sin(y*pi)*sin(2*pi*t) - pi*cos(y*pi))*((2/5)*pi*sin(y*pi)*sin(2*pi*t) - 2*pi*cos(y*pi))*cos(x*pi)/(muion*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^3) - 2/5*pi^2*diffion*cos(x*pi)*cos(y*pi)*cos(2*pi*t)/(muion*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^2) - diffpotential*(-pi^3*diffion*cos(x*pi)/(muion*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)) + 3*pi^3*diffion*sin(x*pi)*cos(x*pi)/(muion*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^2) + 2*pi^3*diffion*cos(x*pi)^3/(muion*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^3))'
    vars = 'muion diffpotential diffion'
    vals = 'muion diffpotential diffion'
  [../]
  [./Ey_source]
  #  type = ParsedFunction
  #  vars = 'ee N_A diffpotential diffion muion'
  #  vals = 'ee N_A diffpotential diffion muion'
  #  value = '-diffpotential*((2*diffion*(pi*cos(pi*y) -
  #  (pi*sin(2*pi*t)*sin(pi*y))/5)^3)/(muion*(sin(x*pi) + sin(y*pi) +
  #  (cos(y*pi)*sin(2*t*pi))/5 + 1)^3) - (diffion*(pi^3*cos(pi*y) -
  #  (pi^3*sin(2*pi*t)*sin(pi*y))/5))/(muion*(sin(pi*x) + sin(pi*y) +
  #  (cos(pi*y)*sin(2*pi*t))/5 + 1)) + (3*diffion*(pi^2*sin(pi*y) +
  #  (pi^2*cos(pi*y)*sin(2*pi*t))/5)*(pi*cos(pi*y) -
  #  (pi*sin(2*pi*t)*sin(pi*y))/5))/(muion*(sin(x*pi) + sin(y*pi) + (cos(y*pi)*sin(2*t*pi))/5 + 1)^2)) - (2*diffion*pi^2*cos(2*pi*t)*sin(pi*y))/(5*muion*(sin(pi*x) + sin(pi*y) + (cos(pi*y)*sin(2*pi*t))/5 + 1)) - (diffion*diffpotential*pi^2*sin(pi*x)*(pi*cos(pi*y) - (pi*sin(2*pi*t)*sin(pi*y))/5))/(muion*(sin(x*pi) + sin(y*pi) + (cos(y*pi)*sin(2*t*pi))/5 + 1)^2) - (2*diffion*diffpotential*pi^2*cos(pi*x)^2*(pi*cos(pi*y) - (pi*sin(2*pi*t)*sin(pi*y))/5))/(muion*(sin(x*pi) + sin(y*pi) + #(cos(y*pi)*sin(2*t*pi))/5 + 1)^3) - (2*diffion*pi*cos(2*pi*t)*cos(pi*y)*(pi*cos(pi*y) - (pi*sin(2*pi*t)*sin(pi*y))/5))/(5*muion*(sin(x*pi) + sin(y*pi) + (cos(y*pi)*sin(2*t*pi))/5 + 1)^2)'
    type = ParsedFunction
    value = '-pi^2*diffion*diffpotential*(-1/5*pi*sin(y*pi)*sin(2*pi*t) + pi*cos(y*pi))*sin(x*pi)/(muion*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^2) - 2*pi^2*diffion*diffpotential*(-1/5*pi*sin(y*pi)*sin(2*pi*t) + pi*cos(y*pi))*cos(x*pi)^2/(muion*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^3) - 2/5*pi*diffion*(-1/5*pi*sin(y*pi)*sin(2*pi*t) + pi*cos(y*pi))*cos(y*pi)*cos(2*pi*t)/(muion*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^2) - 2/5*pi^2*diffion*sin(y*pi)*cos(2*pi*t)/(muion*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)) - diffpotential*(2*diffion*(-pi^2*sin(y*pi) - 1/5*pi^2*sin(2*pi*t)*cos(y*pi))*((1/5)*pi*sin(y*pi)*sin(2*pi*t) - pi*cos(y*pi))/(muion*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^2) + diffion*(pi^2*sin(y*pi) + (1/5)*pi^2*sin(2*pi*t)*cos(y*pi))*(-1/5*pi*sin(y*pi)*sin(2*pi*t) + pi*cos(y*pi))/(muion*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^2) + diffion*(-1/5*pi*sin(y*pi)*sin(2*pi*t) + pi*cos(y*pi))*((1/5)*pi*sin(y*pi)*sin(2*pi*t) - pi*cos(y*pi))*((2/5)*pi*sin(y*pi)*sin(2*pi*t) - 2*pi*cos(y*pi))/(muion*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^3) + diffion*((1/5)*pi^3*sin(y*pi)*sin(2*pi*t) - pi^3*cos(y*pi))/(muion*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)))'
    vars = 'muion diffpotential diffion'
    vals = 'muion diffpotential diffion'
  [../]
