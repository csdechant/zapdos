...
#Source Terms in moles
  ...
  #            sin(pi*y) + (cos(pi*y)*sin(2*pi*t))/5 + 1))^2)/(40*ee*(sin(x*pi) + sin(y*pi) + (cos(y*pi)*sin(2*t*pi))/5 + 1)^2)) / N_A'
    type = ParsedFunction
    value = '-diffmean_en*(24*pi^3*massem*muem^2*(-1/5*pi*sin(y*pi)*sin(2*pi*t) + pi*cos(y*pi))^2*(sin(pi*t) + 1)^2*(sin(x*pi) + sin(y*pi) + 0.2*sin(2*pi*t)*cos(y*pi) + 1.0)/(N_A*ee*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^2) + 3*pi^2*massem*muem*(4*pi*diffem + 8*pi*muem*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1))*(-pi^2*sin(y*pi) - 1/5*pi^2*sin(2*pi*t)*cos(y*pi))*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + 0.2*sin(2*pi*t)*cos(y*pi) + 1.0)/(N_A*ee*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^2) + 6*pi^2*massem*muem*(4*pi*diffem + 8*pi*muem*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1))*(-0.2*pi*sin(y*pi)*sin(2*pi*t) + pi*cos(y*pi))*(-1/5*pi*sin(y*pi)*sin(2*pi*t) + pi*cos(y*pi))*(sin(pi*t) + 1)/(N_A*ee*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^2) + 6*pi^2*massem*muem*(4*pi*diffem + 8*pi*muem*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1))*(-1/5*pi*sin(y*pi)*sin(2*pi*t) + pi*cos(y*pi))*((2/5)*pi*sin(y*pi)*sin(2*pi*t) - 2*pi*cos(y*pi))*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + 0.2*sin(2*pi*t)*cos(y*pi) + 1.0)/(N_A*ee*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^3) + (3/16)*pi*massem*(4*pi*diffem + 8*pi*muem*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1))^2*(-pi^2*sin(y*pi) - 0.2*pi^2*sin(2*pi*t)*cos(y*pi))/(N_A*ee*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^2) + (3/16)*pi*massem*(4*pi*diffem + 8*pi*muem*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1))^2*(2*pi^2*sin(y*pi) + (2/5)*pi^2*sin(2*pi*t)*cos(y*pi))*(sin(x*pi) + sin(y*pi) + 0.2*sin(2*pi*t)*cos(y*pi) + 1.0)/(N_A*ee*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^3) + (3/8)*pi*massem*(4*pi*diffem + 8*pi*muem*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1))^2*(-0.2*pi*sin(y*pi)*sin(2*pi*t) + pi*cos(y*pi))*((2/5)*pi*sin(y*pi)*sin(2*pi*t) - 2*pi*cos(y*pi))/(N_A*ee*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^3) + (3/16)*pi*massem*(4*pi*diffem + 8*pi*muem*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1))^2*((2/5)*pi*sin(y*pi)*sin(2*pi*t) - 2*pi*cos(y*pi))*((3/5)*pi*sin(y*pi)*sin(2*pi*t) - 3*pi*cos(y*pi))*(sin(x*pi) + sin(y*pi) + 0.2*sin(2*pi*t)*cos(y*pi) + 1.0)/(N_A*ee*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^4)) - diffmean_en*(24*pi^5*massem*muem^2*(sin(pi*t) + 1)^2*(sin(x*pi) + sin(y*pi) + 0.2*sin(2*pi*t)*cos(y*pi) + 1.0)*cos(x*pi)^2/(N_A*ee*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^2) - 3*pi^4*massem*muem*(4*pi*diffem + 8*pi*muem*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1))*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + 0.2*sin(2*pi*t)*cos(y*pi) + 1.0)*sin(x*pi)/(N_A*ee*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^2) + 6*pi^4*massem*muem*(4*pi*diffem + 8*pi*muem*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1))*(sin(pi*t) + 1)*cos(x*pi)^2/(N_A*ee*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^2) - 12*pi^4*massem*muem*(4*pi*diffem + 8*pi*muem*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1))*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + 0.2*sin(2*pi*t)*cos(y*pi) + 1.0)*cos(x*pi)^2/(N_A*ee*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^3) - 3/16*pi^3*massem*(4*pi*diffem + 8*pi*muem*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1))^2*sin(x*pi)/(N_A*ee*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^2) + (3/8)*pi^3*massem*(4*pi*diffem + 8*pi*muem*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1))^2*(sin(x*pi) + sin(y*pi) + 0.2*sin(2*pi*t)*cos(y*pi) + 1.0)*sin(x*pi)/(N_A*ee*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^3) - 3/4*pi^3*massem*(4*pi*diffem + 8*pi*muem*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1))^2*cos(x*pi)^2/(N_A*ee*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^3) + (9/8)*pi^3*massem*(4*pi*diffem + 8*pi*muem*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1))^2*(sin(x*pi) + sin(y*pi) + 0.2*sin(2*pi*t)*cos(y*pi) + 1.0)*cos(x*pi)^2/(N_A*ee*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^4)) + 0.075*pi^2*massem*(4*pi*diffem + 8*pi*muem*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1))^2*cos(y*pi)*cos(2*pi*t)/(N_A*ee*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^2) - 3/20*pi^2*massem*(4*pi*diffem + 8*pi*muem*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1))^2*(sin(x*pi) + sin(y*pi) + 0.2*sin(2*pi*t)*cos(y*pi) + 1.0)*cos(y*pi)*cos(2*pi*t)/(N_A*ee*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^3) + (3/16)*pi*massem*(4*pi*diffem + 8*pi*muem*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1))*((32/5)*pi^2*muem*(sin(pi*t) + 1)*cos(y*pi)*cos(2*pi*t) + 16*pi^2*muem*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)*cos(pi*t))*(sin(x*pi) + sin(y*pi) + 0.2*sin(2*pi*t)*cos(y*pi) + 1.0)/(N_A*ee*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^2)'
    vars = 'massem diffmean_en diffem muem ee N_A'
    vals = 'massem diffmean_en diffem muem ee N_A'
  [../]
