...
#Source Terms in moles
  ...
  #            sin(y*pi) + (cos(y*pi)*sin(2*t*pi))/5 + 1))/5)^3)) / N_A'
    type = ParsedFunction
    value = '-diffem*((32768/25)*pi*ee*mumean_en^2*(-1/5*pi*sin(y*pi)*sin(2*pi*t) + pi*cos(y*pi))^2*(sin(pi*t) + 1)^2*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^3/(N_A*massem*((12/5)*pi*diffmean_en + (32/5)*pi*mumean_en*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1))^4) - 1024/15*ee*mumean_en*(-pi^2*sin(y*pi) - 1/5*pi^2*sin(2*pi*t)*cos(y*pi))*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^3/(N_A*massem*((12/5)*pi*diffmean_en + (32/5)*pi*mumean_en*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1))^3) - 2048/15*ee*mumean_en*(-3/5*pi*sin(y*pi)*sin(2*pi*t) + 3*pi*cos(y*pi))*(-1/5*pi*sin(y*pi)*sin(2*pi*t) + pi*cos(y*pi))*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^2/(N_A*massem*((12/5)*pi*diffmean_en + (32/5)*pi*mumean_en*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1))^3) + (16/3)*ee*(-3*pi^2*sin(y*pi) - 3/5*pi^2*sin(2*pi*t)*cos(y*pi))*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^2/(pi*N_A*massem*((12/5)*pi*diffmean_en + (32/5)*pi*mumean_en*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1))^2) + (16/3)*ee*(-3/5*pi*sin(y*pi)*sin(2*pi*t) + 3*pi*cos(y*pi))*(-2/5*pi*sin(y*pi)*sin(2*pi*t) + 2*pi*cos(y*pi))*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)/(pi*N_A*massem*((12/5)*pi*diffmean_en + (32/5)*pi*mumean_en*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1))^2)) - diffem*((32768/25)*pi^3*ee*mumean_en^2*(sin(pi*t) + 1)^2*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^3*cos(x*pi)^2/(N_A*massem*((12/5)*pi*diffmean_en + (32/5)*pi*mumean_en*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1))^4) + (1024/15)*pi^2*ee*mumean_en*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^3*sin(x*pi)/(N_A*massem*((12/5)*pi*diffmean_en + (32/5)*pi*mumean_en*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1))^3) - 2048/5*pi^2*ee*mumean_en*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^2*cos(x*pi)^2/(N_A*massem*((12/5)*pi*diffmean_en + (32/5)*pi*mumean_en*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1))^3) - 16*pi*ee*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^2*sin(x*pi)/(N_A*massem*((12/5)*pi*diffmean_en + (32/5)*pi*mumean_en*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1))^2) + 32*pi*ee*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)*cos(x*pi)^2/(N_A*massem*((12/5)*pi*diffmean_en + (32/5)*pi*mumean_en*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1))^2)) + (32/5)*ee*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^2*cos(y*pi)*cos(2*pi*t)/(N_A*massem*((12/5)*pi*diffmean_en + (32/5)*pi*mumean_en*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1))^2) + (16/3)*ee*(-128/25*pi^2*mumean_en*(sin(pi*t) + 1)*cos(y*pi)*cos(2*pi*t) - 64/5*pi^2*mumean_en*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)*cos(pi*t))*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1)^3/(pi*N_A*massem*((12/5)*pi*diffmean_en + (32/5)*pi*mumean_en*(sin(pi*t) + 1)*(sin(x*pi) + sin(y*pi) + (1/5)*sin(2*pi*t)*cos(y*pi) + 1))^3)'
    vars = 'ee massem diffmean_en diffem mumean_en N_A'
    vals = 'ee massem diffmean_en diffem mumean_en N_A'
  [../]
  #The ion source term.
  [./ion_source]
  #  type = ParsedFunction
  ...
  #           2*cos(pi*y)*sin(2*pi*t)*sin(pi*y) + 10))/5) / N_A'
    ...
    vars = 'diffion N_A muion'
    vals = 'diffion N_A muion'
  [../]
  [./energy_source]
  #  type = ParsedFunction
  #  vars = 'ee N_A diffpotential diffem muem massem diffmean_en mumean_en diffion muion'
