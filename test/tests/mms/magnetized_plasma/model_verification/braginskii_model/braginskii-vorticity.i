...
[Materials]
  ...
  [minus_B_mag_squared]
    type = ADParsedMaterial
    material_property_names = 'mag_magnetic_field'
    expression = '-1.0*mag_magnetic_field*mag_magnetic_field'
    property_name = 'minus_B_mag_squared'
  []
  [B_mag_squared]
    type = ADParsedMaterial
    material_property_names = 'mag_magnetic_field'
    expression = 'mag_magnetic_field*mag_magnetic_field'
    property_name = 'B_mag_squared'
  []
  [minus_B_mag_squared_J_div_density]
    type = ADParsedMaterial
    material_property_names = 'mag_magnetic_field'
    coupled_variables = 'density electron_velocity ion_velocity'
    expression = '-1.0*mag_magnetic_field*mag_magnetic_field*(ion_velocity - electron_velocity)/density'
    property_name = 'minus_B_mag_squared_J_div_density'
  []

  [minus_two_B_mag]
    type = ADParsedMaterial
    material_property_names = 'mag_magnetic_field'
    expression = '-2.0*mag_magnetic_field'
    property_name = 'minus_two_B_mag'
  []
  [minus_two_B_mag_times_electron_temp_div_density]
    type = ADParsedMaterial
    material_property_names = 'mag_magnetic_field'
    coupled_variables = 'electron_temp density'
    expression = '-2.0*mag_magnetic_field * electron_temp/density'
    property_name = 'minus_two_B_mag_times_electron_temp_div_density'
  []

  [vorticity_perpendicular_diffusion]
    type = ADParsedMaterial
    expression = '1.0'
    property_name = 'perp_diffvorticity'
  []
[]
...
[Kernels]
  ...
  #   variable = vorticity
  # []
  # V_ExB Grad vorticity
  [ExB_bracket_vorticity]
    type = MatBracketOperatorLin
    variable = vorticity
    mat_coeff = B_mag_inverse
    v = potential
  ...
  [vorticity_parallel_grad_ion_velocity]
    type = CoeffParallelDiffusionLin
    variable = vorticity
    mat_coeff = 'minus_B_mag_squared'
    v = ion_velocity
  []
  [vorticity_parallel_grad_elec_velocity]
    type = CoeffParallelDiffusionLin
    variable = vorticity
    mat_coeff = 'B_mag_squared'
    v = electron_velocity
  []
  [vorticity_parallel_grad_density]
    type = CoeffParallelDiffusionLin
    variable = vorticity
    mat_coeff = 'minus_B_mag_squared_J_div_density'
    v = density
  []

  [vorticity_curvature_operator_on_potential]
    type = MatCurvatureOperatorLin
    variable = vorticity
    mat_coeff = 'minus_two_B_mag'
    v = potential
  []
  [vorticity_curvature_operator_on_density]
    type = MatCurvatureOperatorLin
    variable = vorticity
    mat_coeff = 'minus_two_B_mag_times_electron_temp_div_density'
    v = density
  []

  [vorticity_forcing_term]
    type = ADBodyForce
    variable = vorticity
    function = vorticity_source_term
  []
...
[Functions]
  ...
  [vorticity_solution]
    ...
    # expression = '28.2922666666667*sin(6.28*x)*sin(x - z) - 0.0269589333333333*sin(6.28*x)*cos(y - z) - 0.00837333333333333*sin(y - z)*cos(6.28*x) - 12.56*cos(6.28*x)*cos(x - z)'
    # expression = '(((-2.64*sin(5.28*x + z) + 3.64*sin(7.28*x - z) - 0.00314*cos(6.28*x - y + z) - 0.00314*cos(6.28*x + y - z))*sin(y + z) - 0.001*sin(6.28*x)*sin(y - z)*cos(x + z))*(sin(x + z) + cos(y + z))*sin(y + z)*cos(x + z) - ((-(-2.64*sin(5.28*x + z) + 3.64*sin(7.28*x - z) - 0.00314*cos(6.28*x - y + z) - 0.00314*cos(6.28*x + y - z))*sin(y + z) + 0.001*sin(6.28*x)*sin(y - z)*cos(x + z))*sin(y + z)*cos(y + z) + (sin(y + z)^2 + cos(x + z)^2)*((-2.64*sin(5.28*x + z) + 3.64*sin(7.28*x - z) - 0.00314*cos(6.28*x - y + z) - 0.00314*cos(6.28*x + y - z))*cos(y + z) - 0.001*sin(6.28*x)*cos(x + z)*cos(y - z) + 0.00628*sin(y - z)*sin(y + z)*cos(6.28*x)))*cos(x + z) + (((-2.64*sin(5.28*x + z) + 3.64*sin(7.28*x - z) - 0.00314*cos(6.28*x - y + z) - 0.00314*cos(6.28*x + y - z))*sin(y + z) - 0.001*sin(6.28*x)*sin(y - z)*cos(x + z))*sin(x + z)*cos(x + z) + (sin(y + z)^2 + cos(x + z)^2)*((0.0197192*sin(6.28*x - y + z) + 0.0197192*sin(6.28*x + y - z) - 13.9392*cos(5.28*x + z) + 26.4992*cos(7.28*x - z))*sin(y + z) + 0.001*sin(6.28*x)*sin(x + z)*sin(y - z) - 0.00628*sin(y - z)*cos(6.28*x)*cos(x + z)))*sin(y + z) + (sin(y + z)^2 + cos(x + z)^2)^2*(-0.0207192*sin(6.28*x - y + z) - 0.0207192*sin(6.28*x + y - z) + 14.4392*cos(5.28*x + z) - 26.9992*cos(7.28*x - z)))/(sin(y + z)^2 + cos(x + z)^2)^2'
    expression = '2*cos(x + 4*y - z)'
  []
  ...
  [vorticity_source_term]
    ...
    # expression = '2*(-2*(sin(x*y*z) - 5*cos(x*y*z))*(cos(x*y*z)^2 + 1)^(11/2)*sin(z + (x - 0.5)^2)*sin(x + 4*y - z) + (sin(x*y*z) - 5*cos(x*y*z))*(cos(x*y*z)^2 + 1)^5*(x*y*sin(x*y*z) - x*z*sin(x*y*z) - y*z*cos(x*y*z))*sin(x + 4*y - z) + (sin(x*y*z) - 5*cos(x*y*z))*(cos(x*y*z)^2 + 1)^4*(-x*y*cos(x*y*z) + x*z*cos(x*y*z) - y*z*sin(x*y*z))*sin(x*y*z)*sin(x + 4*y - z)*cos(x*y*z) + 18*(cos(x*y*z)^2 + 1)^6*cos(x + 4*y - z) + (cos(2*x*y*z) + 3)^4*(-8*x*y*sin(x + 4*y - z) + 4*x*y*sin(2*x*y*z - x - 4*y + z) - 4*x*y*sin(2*x*y*z + x + 4*y - z) - 10*x*y*cos(2*x*y*z - x - 4*y + z) + 10*x*y*cos(2*x*y*z + x + 4*y - z) + 8*x*z*sin(x + 4*y - z) - 4*x*z*sin(2*x*y*z - x - 4*y + z) + 4*x*z*sin(2*x*y*z + x + 4*y - z) + 10*x*z*cos(2*x*y*z - x - 4*y + z) - 10*x*z*cos(2*x*y*z + x + 4*y - z) - 20*y*z*sin(x + 4*y - z) - 10*y*z*sin(2*x*y*z - x - 4*y + z) + 10*y*z*sin(2*x*y*z + x + 4*y - z) - 4*y*z*cos(2*x*y*z - x - 4*y + z) + 4*y*z*cos(2*x*y*z + x + 4*y - z) + 30*sin(2*x*y*z - x - 4*y + z) + 30*sin(2*x*y*z + x + 4*y - z) + 5*sin(4*x*y*z - x - 4*y + z) + 5*sin(4*x*y*z + x + 4*y - z) - 180*cos(x + 4*y - z) - 98*cos(2*x*y*z - x - 4*y + z) - 98*cos(2*x*y*z + x + 4*y - z) - 12*cos(4*x*y*z - x - 4*y + z) - 12*cos(4*x*y*z + x + 4*y - z))/128)/(cos(x*y*z)^2 + 1)^6'
    # expression = '(-4*(sin(x*y*z) - 5*cos(x*y*z))*(cos(x*y*z)^2 + 1)^(11/2)*sin(z + (x - 0.5)^2)*sin(x + 4*y - z) + 2*(sin(x*y*z) - 5*cos(x*y*z))*(cos(x*y*z)^2 + 1)^4*(-x*y*cos(x*y*z) + x*z*cos(x*y*z) - y*z*sin(x*y*z))*sin(x*y*z)*sin(x + 4*y - z)*cos(x*y*z) + 36*(cos(x*y*z)^2 + 1)^6*cos(x + 4*y - z) + (cos(x*y*z)^2 + 1)^5*(x*y*(-5*sin(2*x*y*z) - cos(2*x*y*z) + 1) - x*z*(-5*sin(2*x*y*z) - cos(2*x*y*z) + 1) - y*z*(sin(2*x*y*z) - 5*cos(2*x*y*z) - 5) + (0.006*sin(y - z) + 8*cos(x - z))*sin(6.28*x)*sin(x*y*z) + 2*(3.14*sin(5.28*x + z) - 3.14*sin(7.28*x - z) + 0.00364*cos(6.28*x - y + z) + 0.00264*cos(6.28*x + y - z))*cos(x*y*z) - (21.12*sin(5.28*x + z) - 29.12*sin(7.28*x - z) + 0.02612*cos(6.28*x - y + z) + 0.02412*cos(6.28*x + y - z))*cos(x*y*z))*sin(x + 4*y - z) + (cos(2*x*y*z) + 3)^4*(-8*x*y*sin(x + 4*y - z) + 4*x*y*sin(2*x*y*z - x - 4*y + z) - 4*x*y*sin(2*x*y*z + x + 4*y - z) - 10*x*y*cos(2*x*y*z - x - 4*y + z) + 10*x*y*cos(2*x*y*z + x + 4*y - z) + 8*x*z*sin(x + 4*y - z) - 4*x*z*sin(2*x*y*z - x - 4*y + z) + 4*x*z*sin(2*x*y*z + x + 4*y - z) + 10*x*z*cos(2*x*y*z - x - 4*y + z) - 10*x*z*cos(2*x*y*z + x + 4*y - z) - 20*y*z*sin(x + 4*y - z) - 10*y*z*sin(2*x*y*z - x - 4*y + z) + 10*y*z*sin(2*x*y*z + x + 4*y - z) - 4*y*z*cos(2*x*y*z - x - 4*y + z) + 4*y*z*cos(2*x*y*z + x + 4*y - z) + 30*sin(2*x*y*z - x - 4*y + z) + 30*sin(2*x*y*z + x + 4*y - z) + 5*sin(4*x*y*z - x - 4*y + z) + 5*sin(4*x*y*z + x + 4*y - z) - 180*cos(x + 4*y - z) - 98*cos(2*x*y*z - x - 4*y + z) - 98*cos(2*x*y*z + x + 4*y - z) - 12*cos(4*x*y*z - x - 4*y + z) - 12*cos(4*x*y*z + x + 4*y - z))/64)/(cos(x*y*z)^2 + 1)^6'
    # expression = '((x*(0.5*cos(3*x^2 - 2*z) + 1)*(-0.01125*y*cos(x*y*z - y + z) - 0.01125*y*cos(x*y*z + y - z) + 0.00125*y*cos(3*x*y*z - y + z) + 0.00125*y*cos(3*x*y*z + y - z) - 0.01125*z*cos(x*y*z - y + z) - 0.01125*z*cos(x*y*z + y - z) + 0.00125*z*cos(3*x*y*z - y + z) + 0.00125*z*cos(3*x*y*z + y - z) + 0.9*(y + z)*(cos(x*y*z)^2 + 1)*sin(x*y*z) - 1.8*(y + z)*sin(x*y*z)*cos(x*y*z)^2) + (x^2*(-2.25*y*sin(x*y*z) + 0.75*y*sin(3*x*y*z) - 2.25*z*sin(x*y*z) + 0.75*z*sin(3*x*y*z)) + z*(2.25*x*cos(x*y*z) - 0.25*x*cos(3*x*y*z) - 0.75*y*sin(x*y*z) + 0.25*y*sin(3*x*y*z)))*(0.9*x + 0.01*sin(y - z) + 0.9)*sin(3*x^2 - 2*z))*(cos(x*y*z)^2 + 1)^(25/2) + 2*(sin(x*y*z) - 5*cos(x*y*z))*(cos(x*y*z)^2 + 1)^(23/2)*(0.9*x + 0.01*sin(y - z) + 0.9)*(-x*y*cos(x*y*z) + x*z*cos(x*y*z) - y*z*sin(x*y*z))*sin(x*y*z)*sin(x + 4*y - z)*cos(x*y*z) - 4*(sin(x*y*z) - 5*cos(x*y*z))*(cos(x*y*z)^2 + 1)^13*(0.9*x + 0.01*sin(y - z) + 0.9)*sin(z + (x - 0.5)^2)*sin(x + 4*y - z) + 36*(cos(x*y*z)^2 + 1)^(27/2)*(0.9*x + 0.01*sin(y - z) + 0.9)*cos(x + 4*y - z) + (cos(x*y*z)^2 + 1)^(25/2)*(0.9*x + 0.01*sin(y - z) + 0.9)*(x*y*(-5*sin(2*x*y*z) - cos(2*x*y*z) + 1) - x*z*(-5*sin(2*x*y*z) - cos(2*x*y*z) + 1) - y*z*(sin(2*x*y*z) - 5*cos(2*x*y*z) - 5) + (0.006*sin(y - z) + 8*cos(x - z))*sin(6.28*x)*sin(x*y*z) + 2*(3.14*sin(5.28*x + z) - 3.14*sin(7.28*x - z) + 0.00364*cos(6.28*x - y + z) + 0.00264*cos(6.28*x + y - z))*cos(x*y*z) - (21.12*sin(5.28*x + z) - 29.12*sin(7.28*x - z) + 0.02612*cos(6.28*x - y + z) + 0.02412*cos(6.28*x + y - z))*cos(x*y*z))*sin(x + 4*y - z) + (cos(x*y*z)^2 + 1)^(23/2)*(0.9*x + 0.01*sin(y - z) + 0.9)*(-8*x*y*sin(x + 4*y - z) + 4*x*y*sin(2*x*y*z - x - 4*y + z) - 4*x*y*sin(2*x*y*z + x + 4*y - z) - 10*x*y*cos(2*x*y*z - x - 4*y + z) + 10*x*y*cos(2*x*y*z + x + 4*y - z) + 8*x*z*sin(x + 4*y - z) - 4*x*z*sin(2*x*y*z - x - 4*y + z) + 4*x*z*sin(2*x*y*z + x + 4*y - z) + 10*x*z*cos(2*x*y*z - x - 4*y + z) - 10*x*z*cos(2*x*y*z + x + 4*y - z) - 20*y*z*sin(x + 4*y - z) - 10*y*z*sin(2*x*y*z - x - 4*y + z) + 10*y*z*sin(2*x*y*z + x + 4*y - z) - 4*y*z*cos(2*x*y*z - x - 4*y + z) + 4*y*z*cos(2*x*y*z + x + 4*y - z) + 30*sin(2*x*y*z - x - 4*y + z) + 30*sin(2*x*y*z + x + 4*y - z) + 5*sin(4*x*y*z - x - 4*y + z) + 5*sin(4*x*y*z + x + 4*y - z) - 180*cos(x + 4*y - z) - 98*cos(2*x*y*z - x - 4*y + z) - 98*cos(2*x*y*z + x + 4*y - z) - 12*cos(4*x*y*z - x - 4*y + z) - 12*cos(4*x*y*z + x + 4*y - z))/4)/((cos(x*y*z)^2 + 1)^(27/2)*(0.9*x + 0.01*sin(y - z) + 0.9))'

    expression = '((0.05*(0.9*sin(x*y*z) - 0.02*cos(x*y*z)*cos(y - z))*cos(3*x^2 + 2*y - 2*z) - (0.9*x + 0.01*sin(y - z) + 0.9)*(0.15*x*cos(3*x^2 - x*y*z + 2*y - 2*z) - 0.15*x*cos(3*x^2 + x*y*z + 2*y - 2*z) - 0.1*sin(3*x^2 - x*y*z + 2*y - 2*z) - 0.1*sin(3*x^2 + x*y*z + 2*y - 2*z)))*(cos(x*y*z)^2 + 1)^14 + (x*(0.5*cos(3*x^2 - 2*z) + 1)*(-0.01125*y*cos(x*y*z - y + z) - 0.01125*y*cos(x*y*z + y - z) + 0.00125*y*cos(3*x*y*z - y + z) + 0.00125*y*cos(3*x*y*z + y - z) - 0.01125*z*cos(x*y*z - y + z) - 0.01125*z*cos(x*y*z + y - z) + 0.00125*z*cos(3*x*y*z - y + z) + 0.00125*z*cos(3*x*y*z + y - z) + 0.9*(y + z)*(cos(x*y*z)^2 + 1)*sin(x*y*z) - 1.8*(y + z)*sin(x*y*z)*cos(x*y*z)^2) + (x^2*(-2.25*y*sin(x*y*z) + 0.75*y*sin(3*x*y*z) - 2.25*z*sin(x*y*z) + 0.75*z*sin(3*x*y*z)) + z*(2.25*x*cos(x*y*z) - 0.25*x*cos(3*x*y*z) - 0.75*y*sin(x*y*z) + 0.25*y*sin(3*x*y*z)))*(0.9*x + 0.01*sin(y - z) + 0.9)*sin(3*x^2 - 2*z))*(cos(x*y*z)^2 + 1)^(25/2) + 2*(sin(x*y*z) - 5*cos(x*y*z))*(cos(x*y*z)^2 + 1)^(23/2)*(0.9*x + 0.01*sin(y - z) + 0.9)*(-x*y*cos(x*y*z) + x*z*cos(x*y*z) - y*z*sin(x*y*z))*sin(x*y*z)*sin(x + 4*y - z)*cos(x*y*z) - 4*(sin(x*y*z) - 5*cos(x*y*z))*(cos(x*y*z)^2 + 1)^13*(0.9*x + 0.01*sin(y - z) + 0.9)*sin(z + (x - 0.5)^2)*sin(x + 4*y - z) + 36*(cos(x*y*z)^2 + 1)^(27/2)*(0.9*x + 0.01*sin(y - z) + 0.9)*cos(x + 4*y - z) + (cos(x*y*z)^2 + 1)^(25/2)*(0.9*x + 0.01*sin(y - z) + 0.9)*(x*y*(-5*sin(2*x*y*z) - cos(2*x*y*z) + 1) - x*z*(-5*sin(2*x*y*z) - cos(2*x*y*z) + 1) - y*z*(sin(2*x*y*z) - 5*cos(2*x*y*z) - 5) + (0.006*sin(y - z) + 8*cos(x - z))*sin(6.28*x)*sin(x*y*z) + 2*(3.14*sin(5.28*x + z) - 3.14*sin(7.28*x - z) + 0.00364*cos(6.28*x - y + z) + 0.00264*cos(6.28*x + y - z))*cos(x*y*z) - (21.12*sin(5.28*x + z) - 29.12*sin(7.28*x - z) + 0.02612*cos(6.28*x - y + z) + 0.02412*cos(6.28*x + y - z))*cos(x*y*z))*sin(x + 4*y - z) + (cos(x*y*z)^2 + 1)^(23/2)*(0.9*x + 0.01*sin(y - z) + 0.9)*(-8*x*y*sin(x + 4*y - z) + 4*x*y*sin(2*x*y*z - x - 4*y + z) - 4*x*y*sin(2*x*y*z + x + 4*y - z) - 10*x*y*cos(2*x*y*z - x - 4*y + z) + 10*x*y*cos(2*x*y*z + x + 4*y - z) + 8*x*z*sin(x + 4*y - z) - 4*x*z*sin(2*x*y*z - x - 4*y + z) + 4*x*z*sin(2*x*y*z + x + 4*y - z) + 10*x*z*cos(2*x*y*z - x - 4*y + z) - 10*x*z*cos(2*x*y*z + x + 4*y - z) - 20*y*z*sin(x + 4*y - z) - 10*y*z*sin(2*x*y*z - x - 4*y + z) + 10*y*z*sin(2*x*y*z + x + 4*y - z) - 4*y*z*cos(2*x*y*z - x - 4*y + z) + 4*y*z*cos(2*x*y*z + x + 4*y - z) + 30*sin(2*x*y*z - x - 4*y + z) + 30*sin(2*x*y*z + x + 4*y - z) + 5*sin(4*x*y*z - x - 4*y + z) + 5*sin(4*x*y*z + x + 4*y - z) - 180*cos(x + 4*y - z) - 98*cos(2*x*y*z - x - 4*y + z) - 98*cos(2*x*y*z + x + 4*y - z) - 12*cos(4*x*y*z - x - 4*y + z) - 12*cos(4*x*y*z + x + 4*y - z))/4)/((cos(x*y*z)^2 + 1)^(27/2)*(0.9*x + 0.01*sin(y - z) + 0.9))'
  []
[]
