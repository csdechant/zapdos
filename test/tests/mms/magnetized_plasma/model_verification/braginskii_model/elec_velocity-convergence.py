...
x_pp = 'h'
y_pp = ['electron_velocity_l2Error']
...
for i in range(0, runs):
    ...
    # Read the file
    root = pyhit.load('braginskii-elec_velocity.i')
    ...
    pyhit.write("braginskii-elec_velocity.i", root)

    input_files = ['braginskii-elec_velocity.i']
...
fig.save('braginskii-elec_velocity.png')
data.to_csv('braginskii-elec_velocity.csv')
