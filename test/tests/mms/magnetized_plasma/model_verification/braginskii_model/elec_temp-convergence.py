...
for i in range(0, runs):
    ...
    # Read the file
    root = pyhit.load('braginskii-elec_temp.i')
    ...
    pyhit.write("braginskii-elec_temp.i", root)

    input_files = ['braginskii-elec_temp.i']
...
fig.save('braginskii-elec_temp.png')
data.to_csv('braginskii-elec_temp.csv')
