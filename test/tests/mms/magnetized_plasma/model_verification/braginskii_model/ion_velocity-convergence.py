...
for i in range(0, runs):
    ...
    # Read the file
    root = pyhit.load('braginskii-ion_velocity.i')
    ...
    pyhit.write("braginskii-ion_velocity.i", root)

    input_files = ['braginskii-ion_velocity.i']
...
fig.save('braginskii-ion_velocity.png')
data.to_csv('braginskii-ion_velocity.csv')
