...
for i in range(0, runs+1):
    ...
    # Read the file
    root = pyhit.load('braginskii-density.i')
    ...
    pyhit.write("braginskii-density.i", root)

    input_files = ['braginskii-density.i']
...
fig.save('braginskii-density.png')
data.to_csv('braginskii-density.csv')
