...
for i in range(0, runs):
    ...
    # Read the file
    root = pyhit.load('braginskii-vorticity.i')
    ...
    pyhit.write("braginskii-vorticity.i", root)

    input_files = ['braginskii-vorticity.i']
...
fig.save('braginskii-vorticity.png')
data.to_csv('braginskii-vorticity.csv')
