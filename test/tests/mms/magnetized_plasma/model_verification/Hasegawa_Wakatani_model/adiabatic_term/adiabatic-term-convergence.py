#!/usr/bin/env python3
# Script to run spatial convergence study on adiabatic_term.i
...
for i in range(0, runs):
    ...
    # Read the file
    root = pyhit.load('adiabatic_term.i')
    ...
    pyhit.write("adiabatic_term.i", root)

    input_files = ['adiabatic_term.i']
...
fig.save('adiabatic_term.png')
data.to_csv('adiabatic_term.csv')
