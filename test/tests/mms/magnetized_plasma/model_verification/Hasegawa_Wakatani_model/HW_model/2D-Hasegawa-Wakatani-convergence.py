...
x_pp = 'h'
y_pp = ['density_l2Error','vorticity_l2Error','potential_l2Error']
...
for i in range(0, runs):
    ...
    # Read the file
    root = pyhit.load('2D_Hasegawa_Wakatani.i')
    ...
    pyhit.write("2D_Hasegawa_Wakatani.i", root)

    input_files = ['2D_Hasegawa_Wakatani.i']
...
fig.plot(data, label=['Density', 'Vorticity', 'Potential'], marker='o', markersize=8)
fig.save('2D_Hasegawa_Wakatani.png')
data.to_csv('2D_Hasegawa_Wakatani.csv')
