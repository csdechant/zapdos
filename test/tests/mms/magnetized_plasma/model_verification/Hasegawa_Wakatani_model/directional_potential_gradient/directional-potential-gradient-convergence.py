#!/usr/bin/env python3
# Script to run spatial convergence study on directional_potential_gradient.i
...
for i in range(0, runs):
    ...
    # Read the file
    root = pyhit.load('directional_potential_gradient.i')
    ...
    pyhit.write("directional_potential_gradient.i", root)

    input_files = ['directional_potential_gradient.i']
...
fig.save('directional_potential_gradient.png')
data.to_csv('directional_potential_gradient.csv')
