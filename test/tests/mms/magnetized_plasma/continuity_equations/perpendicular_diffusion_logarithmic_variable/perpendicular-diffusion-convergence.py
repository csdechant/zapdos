#!/usr/bin/env python3
# Script to run spatial convergence study on perpendicular_diffusion.i
...
for i in range(0, runs):
    ...
    # Read the file
    root = pyhit.load('perpendicular_diffusion.i')
    ...
    pyhit.write("perpendicular_diffusion.i", root)

    input_files = ['perpendicular_diffusion.i']
...
fig.save('perpendicular_diffusion.png')
data.to_csv('perpendicular_diffusion.csv')
