...
for i in range(0, runs):
    ...
    # Read the file
    root = pyhit.load('divergence_of_flux.i')
    ...
    pyhit.write("divergence_of_flux.i", root)

    input_files = ['divergence_of_flux.i']
...
fig.save('divergence_of_flux.png')
data.to_csv('divergence_of_flux.csv')
