...
x_pp = 'h'
y_pp = ['EcrossB_vec_l2Error', 'div_EcrossB_vec_l2Error']
...
for i in range(0, runs):
    ...
    # Read the file
    root = pyhit.load('EcrossB_velocity.i')
    ...
    pyhit.write("EcrossB_velocity.i", root)

    input_files = ['EcrossB_velocity.i']
...
fig.plot(data, label=['E X B Vec.','Div(E X B Vec.)'], marker='o', markersize=8)
fig.save('EcrossB_velocity.png')
data.to_csv('EcrossB_velocity.csv')
