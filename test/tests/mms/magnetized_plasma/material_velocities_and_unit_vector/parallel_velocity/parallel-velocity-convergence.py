...
x_pp = 'h'
y_pp = ['parallel_vec_l2Error', 'div_parallel_vec_l2Error']
...
for i in range(0, runs):
    ...
    # Read the file
    root = pyhit.load('parallel_velocity.i')
    ...
    pyhit.write("parallel_velocity.i", root)

    input_files = ['parallel_velocity.i']
...
fig.plot(data, label=['Parallel Vec.','Div(Parallel Vec.)'], marker='o', markersize=8)
fig.save('parallel_velocity.png')
data.to_csv('parallel_velocity.csv')
