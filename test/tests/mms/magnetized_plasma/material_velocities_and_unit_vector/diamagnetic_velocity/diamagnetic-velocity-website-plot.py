...
if "/zapdos/doc/" in script_folder.lower():     # if in documentation folder
    csv_folder = "../../../test/tests/mms/magnetized_plasma/diamagnetic_velocity/gold/diamagnetic_velocity.csv"
...
ax1.loglog(h,velocity, marker='o', linestyle='solid',color='b',label='$\\bf V _D$: {:.3f}'.format(velocity_slope[0]))
ax1.loglog(h,div_velocity, marker='o', linestyle='dashed',color='r',label='$\\nabla \\cdot \\bf V _D$: {:.3f}'.format(div_velocity_slope[0]))
