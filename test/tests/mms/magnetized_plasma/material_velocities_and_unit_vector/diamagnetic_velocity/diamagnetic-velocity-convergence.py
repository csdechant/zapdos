...
x_pp = 'h'
y_pp = ['diamagnetic_vec_l2Error', 'div_diamagnetic_vec_l2Error']
...
for i in range(0, runs):
    ...
    # Read the file
    root = pyhit.load('diamagnetic_velocity.i')
    ...
    pyhit.write("diamagnetic_velocity.i", root)

    input_files = ['diamagnetic_velocity.i']
...
fig.plot(data, label=['Diamagnetic Vec.','Div(Diamagnetic Vec.)'], marker='o', markersize=8)
fig.save('diamagnetic_velocity.png')
data.to_csv('diamagnetic_velocity.csv')
