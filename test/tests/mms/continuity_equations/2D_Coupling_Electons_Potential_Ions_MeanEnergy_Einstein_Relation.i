...
#CoeffDiffusionLin, ChargeSourceMoles_KV, JouleHeating, and
...
#Source Terms in moles
  ...
  [em_source]
    ...
    vars = 'diffpotential ee N_A diffem_coeff muem_coeff f x_max y_max'
    vals = 'diffpotential ee N_A diffem_coeff muem_coeff f x_max y_max'
  []
  ...
  [ion_source]
    ...
    vars = 'diffpotential ee N_A muion f diffion x_max y_max'
    vals = 'diffpotential ee N_A muion f diffion x_max y_max'
  []
  ...
  [energy_source]
    ...
    vars = 'diffpotential coeff ee N_A diffem_coeff muem_coeff f x_max y_max'
    vals = 'diffpotential coeff ee N_A diffem_coeff muem_coeff f x_max y_max'
  []
