...
[DriftDiffusionAction]
  [Plasma]
    charged_particle = Ar_ion # User define name for ions
...
[AuxKernels]
  ...
  [ion_solution]
    ...
    function = '1/( (muAr_ion * 1.6e-19/8.85e-12)*t + (1/${initial_ion_density}) )'
    use_xyzt = true
  []
  ...
  [potential_solution]
    ...
    function = '0.5 * (ion_solution * 1.6e-19) / 8.85e-12 * ((${plasma_length}/2)^2. - (x-${plasma_length}/2)^2.)'
    use_xyzt = true
  []
[]
